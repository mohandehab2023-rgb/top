                    ...
                    ${isAdmin ? `
                        <div class="product-admin-tools">
                            <button type="button" class="product-card-tool-btn" onclick="openRestockModal('${p.id}')" title="تزويد المخزن (+)">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                                <span>تزويد</span>
                            </button>
                            <button type="button" class="product-card-tool-btn" onclick="openEditProductModal('${p.id}')" title="تعديل">
                            ...
                            <button type="button" class="product-card-tool-btn text-danger" onclick="deleteStoreProduct('${p.id}')" title="حذف">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#ef4444" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                                <span>حذف</span>
                            </button>
                        </div>
                    ` : ''}
